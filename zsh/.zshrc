...
PROMPT="
 %{$fg[$colour1]%}%B%n%b%{$reset_color%} %{$fg[$colour3]%}%B>%b%{$reset_color%} %{$fg[$colour4]%}%B%M%b%{$reset_color%}%{$fg[$colour3]%}%B:%b%{$reset_color%} %{$fg[$colour2]%}%B%~%b%{$reset_color%} %{$fg[$colour1]%}%B $RPROMPT|%b%{$reset_color%}
